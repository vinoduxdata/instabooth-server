...
def global_function_setup1():
    if container.mediacollection_service.count() == 0:
        ...
        if container.mediacollection_service.count() == 0:
            ...
            from .util import continue_touch_to_capture

            continue_touch_to_capture()
...
def global_function_setup2():
    ...
    appconfig.actions.image[0].jobcontrol.ask_approval_each_capture = True
    appconfig.actions.image[0].jobcontrol.approve_autoconfirm_timeout = 0.5
